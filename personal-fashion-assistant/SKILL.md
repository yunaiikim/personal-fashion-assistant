...
### 3. `wardrobe_init`
- **功能**：初始化衣橱环境。
- **对应技能定义**：[smart_wardrobe_archiver.md](./smart_wardrobe_archiver.md)（重点参考 §2 Initialization 章节）
...
### 4. `clothing_add`
- **功能**：录入衣物（完整入库流程）。
- **对应技能定义**：[smart_wardrobe_archiver.md](./smart_wardrobe_archiver.md)（重点参考 §3 Execution Logic 章节，涵盖 Step 1~5 全流程）
